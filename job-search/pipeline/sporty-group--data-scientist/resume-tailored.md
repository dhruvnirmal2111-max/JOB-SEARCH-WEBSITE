...
- Approach: owned the account solo, built a product catalogue of roughly 3,000 items, then a pricing-decision dashboard tracking price movement and cost leakage by product, venue and supplier (Python, SQL, statistical analysis), and applied anomaly detection to flag cost-leakage patterns; presented findings directly to the Chief Procurement Officer and category managers.
...
- **Gaming industry:** genuinely new to me. Listed as beneficial, not required, and no gaming experience is claimed anywhere in this resume.
