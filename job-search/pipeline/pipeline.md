...
> The board. Every pursued target lives here. The commander updates status; the owner is the source of truth for "Applied"/"Sent".
> Status flow: **Researching → Applying → Applied → Interviewing → Offer** (or **Closed**).

## Summary
- Active applications: 20
...
| Caterpillar | Junior Data Analyst | caterpillar--junior-data-analyst | Applying | **Owner: confirm location/eligibility (Caterpillar = US/Peoria-based, vs remote-first/India plan) BEFORE submitting**; review PDF + cover letter; `/review-outreach`; `/review-calendar` | confirm fit first | 2026-06-24 |
...
| Brighty | Data Analyst (remote/hybrid — fintech/crypto app: cohort/retention/segmentation, A/B testing; SQL + Metabase/Tableau + BigQuery) | brighty--data-analyst | Applying | Owner: submit application + review outreach; `/review-outreach`; `/review-calendar` | submit by 2026-09-08 | 2026-09-02 |
