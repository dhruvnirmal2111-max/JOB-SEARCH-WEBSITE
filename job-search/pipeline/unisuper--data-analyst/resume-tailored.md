...
I'm a data analyst who works closely with stakeholders to turn business questions into reporting they can actually use. I run BI and reporting across five enterprise client accounts, taking each request from what the stakeholder really needs through to the SQL, the Power BI or Tableau dashboard, and the conversation about what it shows. I care as much about the data being right and well documented as about the report sitting on top of it. On one account, the pricing analysis I structured helped the client find around A$2M in savings in one spend category.
