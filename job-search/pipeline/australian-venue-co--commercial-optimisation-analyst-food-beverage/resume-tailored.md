...
**JD keywords matched:** GP$, GP%, COGS, food cost %, menu engineering, menu performance, pricing analysis, promotional effectiveness, margin analysis, gross margin, sales mix analysis, Power BI, Tableau, Excel (advanced), SQL, Python, dashboards, scorecards, commercial analysis, stakeholder management, cost-optimisation, problem framing, multi-site operations, hospitality / food service, supplier / procurement, category management, reproducible processes, analytical frameworks, commercial mindset, implementation-focused, supplier price-creep, venue-level profitability.

**Added (owner has, not in original resume):** menu engineering, food cost %, gross margin, COGS, supplier price-creep detection, sales mix, promotional performance, venue-level profitability, category deal negotiation support.

**Not applicable / not fabricated:** No formal hospitality employment. Facit and the restaurant-chain engagement provide genuine, direct hospitality domain proof. Facit is labelled as a personal build; the restaurant-chain work is labelled as client work.

**Keyword match rate:** approximately 90% of extractable technical and domain JD keywords covered truthfully.

**Top 3 Recommendations:**
1. Lead interview story: the restaurant-chain engagement. Walk through the three dashboards, the CPO and food-category-manager relationship, and the ~30% largest-category savings outcome. Frame it as menu and category cost analysis in a multi-site food business.
2. Facit is the second story and uniquely compelling: you built the actual tool that does what AVC needs, for a real cafe, with real messy data. Walk through the weekly pulse (food cost %, gross margin, menu engineering, supplier price-creep) and what you learned designing for a non-technical operator.
3. SQL is desirable in the JD and a genuine strength. Emphasise it in conversation: both the restaurant-chain pipeline and the Facit data model are SQL-first.
