...
> **Confirm-first workflow:** the scout adds candidate roles here with a **Posted** date. **Nothing gets built or applied to until you set `Pursue? = yes`.** Edit this file (GitHub / Claude app / laptop) to confirm picks. The engine builds ONLY `Pursue? = yes` rows.
> `Posted` = when the role was advertised (best estimate). "Specific posting" = a real advertised role. "Company target" = strong-fit employer (confirm a live opening first).
> Salary filter (from preferences): **≥ AUD 95,000** — drop anything advertised below.

| Rank | Company | Role | Location | Posted | Why it fits | Fit | Type | Pursue? |
|------|---------|------|----------|--------|-------------|-----|------|---------|
| 1 | Capital.com | Data Engineer (Financial Analytics) | Melbourne | ~Jun 2026 | ETL + data-quality on a multi-jurisdiction financial data platform; fintech | 9 | Specific posting | built |
| 2 | Kogan.com | Data & ML Engineer | Melbourne | ~Jun 2026 | Data pipelines + ML for e-commerce — DE + ML | 9 | Specific posting | built |
| 3 | Karbon | Data Engineer | Melbourne / remote | verify | AI-powered SaaS — agentic-AI/LLM edge | 8 | Specific posting | |
| 4 | Commonwealth Bank (CommBank) | Data Scientist / Data & AI | Melbourne/Syd | verify | Large DS & AI community; ML/AI scope, comp | 8 | Company target | |
| 5 | Macquarie Group | Data Engineer | Melbourne/Syd | verify | Financial services; strong comp ceiling | 8 | Company target | |
| 6 | SDG Group | Data Engineer (Snowflake & dbt) | Remote/Hybrid | verify | Snowflake; analytics consulting fit | 7 | Specific posting | |
| 7 | Profusion Group | Data Engineer | Melbourne | verify | Data consultancy hiring DEs | 7 | Company target | |
...
- The daily scout appends fresh roles (with Posted dates) for you to confirm. It does NOT build them.
...
### Daily scout — 2026-08-12

| Rank | Company | Role | Location | Posted | Why it fits | Fit | Type | Pursue? |
|------|---------|------|----------|--------|-------------|-----|------|---------|
| 283 | InterWorks | Senior Data Engineer | Melbourne (on-site) | Active Aug 2026 | Independent data & analytics consultancy (US-founded, strong AU practice); client-facing enterprise data platform delivery using Snowflake, Databricks, dbt + cloud; $130–150k confirmed on AU interstate postings; multiple concurrent Melbourne DE openings on Greenhouse (job IDs 4364964006, 4571793006); ETL/ELT client delivery directly matches production pipeline history; **new company on shortlist** | 8 | Specific posting | |
| 284 | NBL (National Basketball League) | Data Scientist | Melbourne (on-site/hybrid) | Active Aug 2026 | Australia's premier basketball league; build predictive models for fan engagement — churn, attendance, retention, ticketing, campaign conversion + fan lifetime value; cross-channel journey analytics; ML production scope matches DS edge; sports-data niche + high public profile; **new company on shortlist**; est. $95–130k ⚠ verify salary ≥ AUD 95k before applying | 7 | Specific posting | |
| 285 | NBL (National Basketball League) | Data Engineer | Melbourne (on-site/hybrid) | Active Aug 2026 | **Distinct from row 284 (DS)**; design + build data platform integrating diverse sources from live game analytics → fan experience platforms; modern cloud stack; world-renowned basketball org with growing media platform; est. $95–125k ⚠ verify salary ≥ AUD 95k before applying | 7 | Specific posting | |

### Remote-first scout — 2026-08-12

| Rank | Company | Role | Location | Posted | Why it fits / Survives move? | Fit | Type | Pursue? |
|------|---------|------|----------|--------|------------------------------|-----|------|---------|
| R152 | Equinix | Staff Agentic AI Engineer | Bengaluru, India (on-site) | Aug 6, 2026 | Global data-centre / digital infrastructure leader (~$8B revenue); Incubation team builds production LLM agents for the software delivery lifecycle (triage, estimation, design, coding, testing, ops); frameworks: LangGraph, MCP, A2A, Anthropic/OpenAI APIs, Bedrock, Vertex; multi-agent design + RAG / knowledge graphs + AI observability + human-in-the-loop gates; 4–9 yrs exp — strong institutional brand and clear agentic-AI alignment; **new company on shortlist**; est. ₹35–60 LPA. **Survives move: YES** | 9 | Specific posting | |
| R153 | Equinix | Platform Engineer – Data & AI | Bengaluru, India (on-site) | Active Aug 2026 | **Distinct from R152**; architect + build cloud-native GCP platforms for agentic workloads; multi-agent orchestration (CrewAI, LangGraph, AutoGen); LLM/GenAI service integration (OpenAI, Gemini, Claude); Kafka / Pub/Sub event-driven architecture; end-to-end observability; 6–10 yrs exp ⚠ slightly senior — flag if total exp < 6 yrs; est. ₹40–65 LPA. **Survives move: YES** | 8 | Specific posting | |
| R154 | Algoleap Technologies | GenAI Engineer / Agentic AI Architect | Hyderabad, India (on-site) | Aug 5, 2026 (GenAI); Apr 28, 2026 (Architect); Jul 30 (Sr AI Eng) | AI-and-cloud-native product engineering firm (700+ engineers, Fortune 500 clients, 20+ consulting frameworks, 6 patents in progress); multiple live roles: GenAI Engineer (5–8 yrs, Aug 5), Agentic AI Architect (5–10 yrs, Apr), Sr AI Engineer (8–12 yrs, Jul 30); Hyderabad Hi-Tech City campus; RAG + LLM + agentic workflow scope; **new company on shortlist**; est. ₹25–55 LPA (varies by role). **Survives move: YES** | 8 | Specific posting | |
| R155 | EY GDS India | Agentic AI Engineer (Senior) + Data Engineer (Senior) | Bengaluru / Hyderabad / Kolkata, India | Active Aug 2026 | Ernst & Young Global Delivery Services — India technology arm (distinct from EY Australia rows 49 / 172); two role tracks: (a) Agentic AI Engineer Senior: LangChain, LangGraph, Semantic Kernel, RAG pipelines, autonomous agents + multi-agent orchestration flows, 5–10 yrs; (b) Data Engineer Senior: Databricks + Snowflake + Spark + ADF + PySpark pipelines, Hyderabad/Bengaluru, 4–8 yrs; consulting scale, Big-4 brand for India market; est. ₹22–45 LPA. **Survives move: YES** | 8 | Specific posting | |
| R156 | Knowledge Foundry | AI Platform Engineer (LLMs / Agentic AI / RAG) | Chennai, India | Jul 13, 2026 | Builds enterprise AI platform infrastructure — LLM orchestration, agentic AI workflows, RAG pipelines + vector store integration; 5–8 yrs exp; **new company on shortlist**; Chennai-based est. ₹20–35 LPA ⚠ verify still open (Jul post). **Survives move: YES** | 7 | Specific posting | |
| R157 | Gainwell Technologies | Gen AI Engineer – RAG Systems & AI Transformation | Bangalore, India (remote India) | Active 2026 | Specialised healthcare-IT company (~11k employees); production RAG + agentic AI delivery: LangChain, LangGraph, CrewAI / OpenAI Swarm; vector databases + graph databases; explicitly "Agentic AI Frameworks and Workflow" required; India-remote confirmed; **new company on shortlist**; est. ₹20–38 LPA. **Survives move: YES** | 7 | Specific posting | |
| R158 | Ollion | Lead – AI/ML Engineer (Generative AI Agent Systems) | Pune, India (hybrid) | Active Aug 2026 | Global cloud consultancy ("built for problems that lack playbooks"); lead-level GenAI agent system design + enterprise service delivery; Principal SME for GenAI practice; Python + LLM APIs; **distinct from Lead Engineer Data (also on offer at Ollion)**; **new company on shortlist**; est. ₹25–45 LPA. **Survives move: YES** | 7 | Specific posting | |
| R159 | DataOrbit AI | Data Engineer | India (fully remote) | Aug 11, 2026 | AI consulting firm helping small/mid investment managers become AI-ready; designs scalable cloud-native data pipelines + ETL supporting AI/analytics initiatives; freshest posting in this scout (Aug 11); **new company on shortlist**; small team = high ownership; est. ₹18–30 LPA ⚠ verify salary range before applying. **Survives move: YES** | 7 | Specific posting | |
| R160 | Wadhwani Foundation | Agentic AI Implementation Engineer | Bengaluru, India (on-site, North Bangalore) | Apr 2025 (⚠ verify still open) | India's premier applied AI nonprofit (AI for social good — agriculture, healthcare, education, skilling); agentic RAG pipelines + LLM agents with task planning + contextual decision-making + tool integration + vector stores; 3–6 yrs exp — most accessible experience bar in this scout; **new company on shortlist**; est. ₹18–35 LPA (nonprofit band, confirm). **Survives move: YES** | 7 | Specific posting | |

### Daily scout sources — 2026-08-12 (rows 283–285, R152–R160)
- [InterWorks — Data Engineer, Melbourne (Greenhouse job 4364964006)](https://job-boards.greenhouse.io/interworks/jobs/4364964006)
- [InterWorks — Senior Data Engineer, Melbourne (Greenhouse job 4571793006)](https://job-boards.greenhouse.io/interworks/jobs/4571793006)
- [InterWorks — Jobs at InterWorks (Greenhouse)](https://job-boards.greenhouse.io/interworks)
- [NBL — Data Scientist, Melbourne (Sportspeople job 86756)](https://www.sportspeople.com.au/jobs/86756-data-scientist-nbl)
- [NBL — Data Engineer, Melbourne (Sportspeople job 86403)](https://www.sportspeople.com.au/jobs/86403-data-engineer-nbl)
- [NBL — Careers (careers.nbl.com.au)](https://careers.nbl.com.au/)
- [Equinix — Staff Agentic AI Engineer, Bengaluru (Naukri job 060826934976)](https://www.naukri.com/job-listings-staff-agentic-ai-engineer-equinix-india-professional-services-private-limited-bengaluru-4-to-9-years-060826934976)
- [Equinix — Staff Agentic AI Engineer, Bengaluru (Equinix Careers)](https://careers.equinix.com/fr/jobs/staff-agentic-ai-engineer-bengaluru-karnataka-india-6c5ff946-85dd-49ce-b23d-a4b5069e35f6)
- [Equinix — Platform Engineer Data & AI, Bengaluru (Equinix Careers)](https://careers.equinix.com/jobs/platform-engineer-data-ai-bengaluru-karnataka-india)
- [Equinix — Platform Engineer Data & AI (aijobs.net job 1238428)](https://aijobs.net/job/1238428-platform-engineer-data-ai/)
- [Algoleap Technologies — GenAI Engineer, Hyderabad (Naukri job 050826027753)](https://www.naukri.com/job-listings-genai-engineer-algoleap-technologies-hyderabad-5-to-8-years-050826027753)
- [Algoleap Technologies — Agentic AI Architect, Hyderabad (Naukri job 280426015744)](https://www.naukri.com/job-listings-agentic-ai-architect-algoleap-technologies-pvt-ltd-hyderabad-5-to-10-years-280426015744)
- [Algoleap Technologies — Sr AI Engineer, Hyderabad (Naukri job 300726013841)](https://www.naukri.com/job-listings-sr-ai-engineer-algoleap-technologies-hyderabad-8-to-12-years-300726013841)
- [Algoleap — Careers (algoleap.com)](https://careers.algoleap.com/jobs/Careers)
- [EY GDS — Agentic AI Engineer Senior, Kolkata (careers.ey.com job 1404948533)](https://careers.ey.com/ey/job/Kolkata-EY-GDS-Consulting-AIA-Agentic-AI-Engineer-Senior-WB-700091/1404948533/)
- [EY GDS — Agentic AI Engineer Senior, Bengaluru (careers.ey.com job 1416693133)](https://careers.ey.com/ey/job/Bengaluru-EY-GDS-Consulting-AIA%C2%A0-Agentic-AI-Senior-KA-560048/1416693133/)
- [EY GDS — Data Engineer Senior, Hyderabad (careers.ey.com job 1406774133)](https://careers.ey.com/ey/job/Hyderabad-EY-GDS-Consulting-AI-And-DATA-DataEngineer-senior-TG-500081/1406774133/)
- [Knowledge Foundry — AI Platform Engineer LLMs Agentic AI RAG, Chennai (Naukri job 130726003295)](https://www.naukri.com/job-listings-ai-platform-engineer-llms-agentic-ai-orchestration-rag-knowledge-foundry-chennai-5-to-8-years-130726003295)
- [Gainwell Technologies — Gen AI Engineer RAG Systems, Bangalore (jobs.gainwelltechnologies.com)](https://jobs.gainwelltechnologies.com/job/Bangalore-Gen-AI-Engineer-RAG-Systems-&-AI-Transformation-KA-560100/1342239000/)
- [Gainwell Technologies — Senior AI Engineer, Bangalore (jobs.gainwelltechnologies.com)](https://jobs.gainwelltechnologies.com/job/Bangalore-Senior-AI-Engineer-KA-560100/1376650200/)
- [Ollion — Lead AI/ML Engineer Generative AI Agent Systems, Pune (SmartRecruiters)](https://jobs.smartrecruiters.com/Ollion/744000138022259-lead-ai-ml-engineer-generative-ai-agent-systems-)
...
### Daily scout — 2026-09-07

| Rank | Company | Role | Location | Posted | Why it fits | Fit | Type | Pursue? |
|------|---------|------|----------|--------|-------------|-----|------|---------|
| 326 | Future Secure AI | Senior AI Engineer – Data Science (Agentic AI Co-workers) | Melbourne / Sydney / Brisbane (hybrid) | Active Sep 2026 | Backed by OpenAI + NVIDIA strategic partnerships; Senior technical lead role designing, deploying + governing production agentic LLM co-workers, multi-step reasoning systems, and enterprise-grade autonomous workflows — planning, tool-use, workflow orchestration, advanced LLM agents at scale; directly maps to the Job Hunt OS multi-agent architecture; new company on shortlist; est. AUD $150k–$200k (Glassdoor median $150k; senior agentic band higher). ⚠️ Glassdoor culture rating dropped 41% last 12 months — verify team + WFH ratio before committing | 8 | Specific posting | |
| 327 | NAB | AI Scientist | Melbourne CBD / Sydney CBD (hybrid) | Active Sep 2026 | Australia's second-largest bank; delivery-focused practitioner role that translates advanced AI capabilities — LLMs, GenAI, agentic systems — into measurable business outcomes at enterprise scale; partners with AI engineers + product leads to implement prompting strategies + retrieval pipelines + rigorous LLM evaluation; **DISTINCT from row 20 (Data Engineer)**; est. AUD $130k–$165k (based on NAB DS bands; AI Scientist specialisation above DS median) ⚠️ salary not advertised — verify range before applying | 7 | Specific posting | |
| 328 | NAB | Senior AI Scientist | Melbourne CBD / Sydney CBD / Australia-wide (hybrid) | Active Sep 2026 | Senior tier of the same NAB AI practice; leads design + implementation of AI solutions across multiple squads; guides how systems are developed, evaluated + scaled in a regulated banking environment; production LLMs + agentic systems at AU's 2nd-largest bank; **DISTINCT from rows 20 (DE) and 327 (AI Scientist)**; est. AUD $155k–$190k ⚠️ salary not advertised — verify before applying | 8 | Specific posting | |

### Remote-first scout — 2026-09-07

| Rank | Company | Role | Location | Posted | Why it fits / Survives move? | Fit | Type | Pursue? |
|------|---------|------|----------|--------|------------------------------|-----|------|---------|
| R186 | Optum (UnitedHealth Group) | AI or ML Engineer – LLMs, RAG, LangChain, LangGraph | Bengaluru, India | Aug 11, 2026 | Fortune 6 healthcare tech giant; enterprise-grade agentic AI + RAG + AI workflow automation using Spring AI / LangChain / LangGraph + AWS/Azure; reqn 2375302 (job ID 99093468144) — **DISTINCT from R49** (Senior AI/ML Engineer, Jun 28 2026, job ID 97067676544); same elite employer, fresh posting, different seniority band; est. ₹20–35 LPA. **Survives move: YES** | 7 | Specific posting | |
| R187 | Grab | Principal Machine Learning Engineer | Singapore (in-office) | Active 2026 | SEA's largest super-app ($200B+ GMV); Principal/Staff technical anchor on the AI Platform (AIP) team operating core ML + AI infra for 100M+ users — model serving, ML pipelines, LLM fine-tuning, agent-driven products; **DISTINCT from R104 (Senior Data Engineer, SG)**; est. SGD 18k–28k/month base; strong equity track record. ⚠️ Singapore in-office; employer sponsorship/EP required for non-SG citizens. **Survives move: PARTIAL (SG-based)** | 7 | Specific posting | |
| R188 | Grab | Senior AI Engineer | Bengaluru, India (in-office) | Active 2026 | India entity of Grab's GrabAI/Data Science function; solves production batch, real-time, and LLM-driven data science use cases; grows into a domain expert in ML and GenAI feature delivery; **DISTINCT from R104 (Senior DE, Singapore) and R187 (Principal MLE, SG)**; est. ₹30–55 LPA. **Survives move: YES** | 7 | Specific posting | |
| R189 | Stellar Technologies | Machine Learning Engineer (GenAI) | Abu Dhabi, UAE | Active Sep 2026 | UAE tech company building enterprise-grade AI systems; designs + deploys AI pipelines combining LLMs + RAG + agentic frameworks (LangChain, LangGraph, Semantic Kernel) + Azure AI/Cognitive Services + vector DBs (Pinecone, Weaviate, FAISS); bridges model development and production engineering; new company on shortlist; est. AED 200k–400k/yr ⚠️ UAE visa/work permit sponsorship required; verify exact comp + company stability before applying. **Survives move: YES (if sponsorship confirmed)** | 7 | Specific posting | |
| R190 | ANZ Bank | AI Engineer (GenAI – Customer & Banker Assist) | Bengaluru, India (Manyata Tech Park) | Posted May 2026 (verify still open) | ANZ's India technology centre; delivers GenAI-powered voice + messaging AI for ANZ customers and bankers — concierge/triage (Customer Assist), real-time banker guidance (Banker Assist), summarisation + interaction notes + real-time signals; production GenAI at one of AU's Big-4 banks from India; **DISTINCT from row 11 (Melbourne Data Engineer)**; est. ₹20–35 LPA ⚠️ posted May 2026 — confirm listing is still active on careers.anz.com before applying. **Survives move: YES** | 6 | Specific posting | |

### Daily scout sources — 2026-09-07 (rows 326–328, R186–R190)
- [Future Secure AI — Senior AI Engineer Data Science, Melbourne/Sydney/Brisbane (Greenhouse ANZ job 4001501201)](https://job-boards.anz.greenhouse.io/futuresecureai/jobs/4001501201)
- [Future Secure AI — Jobs on SEEK](https://au.seek.com/future-secure-ai-jobs)
- [Future Secure AI — Glassdoor (27 open positions, ratings)](https://www.glassdoor.com.au/Jobs/Future-Secure-AI-Jobs-E10702948.htm)
- [NAB — AI Scientist, Melbourne CBD / Sydney CBD (NAB Careers)](https://careers.nab.com.au/jobs/data-scientist-g3-nsw-sydney-cbd-nsw-australia-vic-melbourne-cbd-vic-australia-wide)
- [NAB — Senior AI Scientist, Melbourne / Sydney / AU-wide (NAB Careers)](https://careers.nab.com.au/jobs/senior-ai-data-scientist-nsw-sydney-cbd-nsw-australia-vic-melbourne-cbd-vic-australia-wide)
- [Optum UHG — AI or ML Engineer LLMs RAG LangChain LangGraph, Bengaluru (UHG Careers reqn 2375302)](https://careers.unitedhealthgroup.com/job/bengaluru/ai-or-ml-engineer-llms-rag-langchain-langgraph/34088/99093468144)
- [Optum UHG — AI or ML Engineer (Built In)](https://builtin.com/job/ai-or-ml-engineer-llms-rag-langchain-langgraph/10666722)
- [Grab — Principal Machine Learning Engineer, Singapore (Grab Careers job 744000138301739)](https://www.grab.careers/en/jobs/744000138301739/principal-machine-learning-engineer/)
- [Grab — Senior AI Engineer, Bengaluru India (Grab Careers job 744000146650079)](https://www.grab.careers/en/jobs/744000146650079/senior-ai-engineer/)
...
### Daily scout — 2026-09-14

| Rank | Company | Role | Location | Posted | Why it fits | Fit | Type | Pursue? |
|------|---------|------|----------|--------|-------------|-----|------|---------|
| 336 | Endeavour Group | Data Scientist – Workforce Planning | Richmond, Melbourne (hybrid) | Aug 24, 2026 (active Sep 7 2026) | AU's largest hospitality/retail group (Dan Murphy's / BWS / ALH Hotels); builds demand-forecasting + labour-optimisation models for 350+ pub venues using GCP, dbt, SQL + Tableau; "by-driver" forecasting translates complex sales drivers into required labour hours; 5+ yrs exp; **DISTINCT from row 87 (Data Scientist, general) and row 88 (ML Engineering Chapter Lead)** — specific Aug 24 posting, dedicated Workforce Planning track; est. AUD $134–$150k (Glassdoor est.) | 7 | Specific posting | |
| 337 | REA Group | Senior Software Engineer, Machine Learning (AI for Property Platform) | Richmond, Melbourne (hybrid) | Active Sep 2026 | Australia's #1 prop-tech platform; builds AI/ML systems for the AI Enrichment squad powering property search/discovery using LLMs + multimodal vision-language models + audience segmentation; Python + PyTorch + AWS + CI/CD + observability; **DISTINCT from row 12 (Senior Data Engineer) and row 171 (Staff MLE, higher level)** — Senior IC role with fresh Sep 2026 activity; est. AUD $145–$195k | 8 | Specific posting | |
| 338 | Neura Vision Pty Ltd | Applied AI Engineer (GenAI / Databricks) | Melbourne (hybrid) | Sep 8, 2026 | Boutique AI consulting firm; contract 3–6 months (potential extension) building end-to-end enterprise GenAI solution for a leading AU financial services org — Python + Databricks + AWS Bedrock; new company on shortlist ⚠ Contract role — confirm daily rate ≥ AUD 95k annualised equivalent before applying | 7 | Specific posting | |

### Remote-first scout — 2026-09-14

| Rank | Company | Role | Location | Posted | Why it fits / Survives move? | Fit | Type | Pursue? |
|------|---------|------|----------|--------|------------------------------|-----|------|---------|
| R195 | Singtel AIDA | Senior AI Engineer | Singapore (hybrid) | Aug 12, 2026 | Singapore's largest telco (Singtel Group) AIDA unit — AI & Data Analytics division; designs + builds + scales agentic AI + GenAI solutions driving business impact; LangChain, LangGraph, Python, TypeScript, MCP (listed as a plus), LLM integration + orchestration; 3–5 yrs exp; new company on shortlist (distinct from any AU Singtel entity); est. SGD 100–140k/yr. ⚠ Singapore EP work-pass sponsorship likely required for non-residents. **Survives move: YES (if SG-based)** | 7 | Specific posting | |
| R196 | Shell | Senior AI Engineer | Singapore (hybrid) | Sep 4, 2026 | Global energy major's Singapore AI practice; designs + builds + deploys scalable GenAI solutions across enterprise workflows — LangChain, LlamaIndex, OpenAI/Anthropic/Cohere APIs, vector DBs (FAISS/Pinecone/Weaviate/Neo4j); full AI solution lifecycle from prototyping to deployment + monitoring; **DISTINCT from Shell Energy Australia (row 91 — Melbourne Data Scientist)**; SGD 120–180k/yr confirmed. ⚠ Singapore EP sponsorship likely required. **Survives move: YES (if SG-based)** | 8 | Specific posting | |
| R197 | Resaro | Senior AI Engineer (Agentic AI Evaluation) | Singapore | Active Sep 2026 | Independent AI assurance startup; owns the production agentic-evaluation engine powering Resaro's Approved Intelligence Platform (AIP) — scores agents on tool-calling, memory, multi-step control + drift/safety; builds evals for government, defence + regulated sector clients; 5+ yrs exp; deep agentic AI knowledge req (multi-turn, stateful, autonomous systems) — a builder of agentic multi-agent systems (Job Hunt OS) evaluating other agents is a rare, high-signal fit; new company on shortlist; est. SGD 120–180k+ (undisclosed — standard senior AI eng SG range). ⚠ Singapore EP sponsorship likely required; early-stage startup — verify funding + runway. **Survives move: YES (if SG-based)** | 9 | Specific posting | |
| R198 | Reliance Jio | AI/ML Engineer | Bengaluru / Mumbai (hybrid) | Active Sep 2026 | India's largest telecom + digital-services conglomerate (Jio Platforms; Ambani family, 500M+ subscribers); AI/ML team builds production ML + GenAI + LLM solutions at hyperscale; 6–10 yrs exp; Python + ML + GenAI; new company on shortlist (first Reliance/Jio entry); Jio GenAI is India's fastest-growing AI division; est. ₹20–40 LPA (verified Glassdoor band; LLM specialisation premium could push higher). **Survives move: YES** | 7 | Specific posting | |

### Daily scout sources — 2026-09-14 (rows 336–338, R195–R198)
- [Endeavour Group — Data Scientist Workforce Planning, Richmond Melbourne (Glassdoor est. $134–$150k)](https://www.glassdoor.com/Job/melbourne-data-scientist-jobs-SRCH_IL.0,9_IM965_KO10,24.htm)
- [Endeavour Group — Data Scientist Workforce Planning (freehire via SmartRecruiters)](https://freehire.me/jobs/data-scientist-workforce-planning-endeavour-group-skdou5gw)
- [REA Group — Senior ML Engineer AI for Property Platform, Melbourne (ZipRecruiter AU job 593844369)](https://www.ziprecruiter.com.au/jobs/593844369-senior-ml-engineer-ai-for-property-platform-hybrid-at-rea-group-ltd)
- [REA Group — Senior Software Engineer ML, Richmond Melbourne (Dreamwork)](https://www.dreamworkhq.com/job/e1b7b310-9629-469e-b83e-8a62a92191d0)
- [Neura Vision Pty Ltd — Applied AI Engineer GenAI Databricks, Melbourne Sep 8 2026 (freehire)](https://freehire.me/jobs/applied-ai-engineer-genai-databricks-neura-vision-pty-ltd-wxgiekeo)
- [Singtel AIDA — Senior AI Engineer, Singapore (Singtel Group Careers job 1330661666)](https://groupcareers.singtel.com/job/Senior-AI-Engineer-AIDA-Sing/1330661666/)
- [Singtel — AIDA Talent Acceleration Day Sep 23 2026 (multiple AIDA roles)](https://freehire.me/jobs/registration-of-interest-for-aida-talent-acceleration-day-23-sept-2026-senior-ai-data-engineer-singtel-hz5jjzzx)
- [Shell — Senior AI Engineer, Singapore Sep 4 2026 (Dreamwork)](https://www.dreamworkhq.com/job/9aabdf31-998e-4451-87fa-1898f2d29372)
- [Resaro — Senior AI Engineer Agentic AI Evaluation, Singapore (freehire)](https://freehire.me/jobs/senior-ai-engineer-agentic-ai-evaluation-resaroai-mcj4j66l)
- [Resaro — Senior AI Engineer (Built In)](https://builtin.com/job/senior-ai-engineer/8109569)
- [Reliance Jio — AI/ML Engineer, Bengaluru/Mumbai (Instahyre job 412169)](https://www.instahyre.com/job-412169-ai-ml-engineer-at-reliance-jio-bangalore-mumbai/)
- [Reliance Jio — AI/ML Engineer salary benchmark (Glassdoor India)](https://www.glassdoor.co.in/Salary/Jio-AI-ML-Engineer-Salaries-E694833_D_KO4,18.htm)

### Daily scout — 2026-09-15

| Rank | Company | Role | Location | Posted | Why it fits | Fit | Type | Pursue? |
|------|---------|------|----------|--------|-------------|-----|------|---------|
| 339 | Atlassian | Senior ML Engineer – AI Context (Rovo AI) | Sydney / Melbourne / Brisbane (distributed-first) | Active Sep 2026 | AI Context team within Rovo + AI org; builds production agentic LLM harnesses powering high-visibility Rovo AI features — contextually aware agents + intelligent experiences; Python + ML/AI + agent frameworks; distributed-first = fully remote from Melbourne confirmed; **DISTINCT from rows 209 (DS), 216 (ML System Engineer), 259 (Anti-Abuse MLE), 282 (GenAI Modeling & Innovation Forge)** — AI Context/Rovo product mission vs. experimentation infra or abuse detection; confirmed employer salary range AUD $198k–$234k | 9 | Specific posting | |
| 340 | CommBank (CBA) | Staff Software Engineer – AI/ML, Payments Technology (AI CoE) | Melbourne / Sydney (hybrid) | Aug 24, 2026 | CBA's Payments Technology AI Centre of Excellence; embeds production AI/ML + agentic workflows into payment operations — intelligent automation, exception handling, fraud investigation; Python + AWS + LLM/agent frameworks; **DISTINCT from rows 238/239 (AI Powered Engineering/developer tooling), 254 (Chief Engineer GenAI), 256 (Fraud & Scams ML Platform), 315/324 (AI Powered Eng)** — Payments Technology is a separate division building AI into payment products, not SDLC tooling; est. AUD $160k–$200k (salary undisclosed; verify before applying) | 8 | Specific posting | |
| 341 | Emmbr | AI Engineer (Agentic Engineering) | Melbourne (hybrid) | Active Sep 2026 | Melbourne AI startup; designs, builds + orchestrates agentic AI systems — AI agents, multi-agent workflows + MCP servers on AWS-preferred cloud infra; Python + LLM/RAG pipelines + vector DBs + MLOps/LLMOps; **new company on shortlist**; MCP servers listed as a core req — a rare, direct match to the Job Hunt OS portfolio; AUD $190k–$210k + bonus confirmed | 9 | Specific posting | |
| 342 | [Confidential global travel co. via Blackroc] | Senior AI / Machine Learning Engineer | Brisbane (hybrid) | Active Sep 2026 | Deliberately small frontier AI team inside a major global travel business; builds production agentic + multi-agent systems from prototype to live traffic — MCP, orchestration, retrieval, ranking + evaluation; 5+ yrs ML/AI, strong Python + full AU working rights; **new company on shortlist**; AUD $150k–$200k ⚠️ Brisbane-primary — confirm Melbourne-remote option before applying | 7 | Specific posting | |

### Remote-first scout — 2026-09-15

| Rank | Company | Role | Location | Posted | Why it fits / Survives move? | Fit | Type | Pursue? |
|------|---------|------|----------|--------|------------------------------|-----|------|---------|
| R199 | Magellan Global PTE. LTD. | Senior AI Engineer – AI Agents / RAG / Fine-Tuning | Singapore (onsite) | ~Aug 24, 2026 | Singapore AI engineering firm; designs + deploys AI agent systems (task planning, tool use, autonomous workflows), builds + optimises RAG pipelines (chunking, embeddings, vector search, retrieval orchestration), fine-tunes LLMs (SFT / RLHF / instruction tuning); 4–6 yrs exp; Python + PyTorch + Hugging Face; posted on MyCareersFuture (SG govt portal — strong posting signal); **new company on shortlist**; SGD 8,000–11,000/month. ⚠️ Singapore EP sponsorship likely required for non-residents. **Survives move: YES (if SG-based)** | 8 | Specific posting | |
| R200 | Infineon Technologies | Contract Staff AI Engineer [LLM-Powered RAG & Agents] (24-month contract) | Singapore (hybrid) | Aug 31, 2026 | Global semiconductor MNC's SG AI team; Agentic RAG + multi-agent systems + GenAI engineering across web/desktop/digital-workplace platforms; drives exploration of emerging AI capabilities, prototypes + deploys production LLM solutions; LangChain + AWS Bedrock + Python; deadline Oct 31 2026; **new company on shortlist**; est. SGD 8k–10k/month; 24-month contract = strong bridge for India-move transition. ⚠️ Confirm EP sponsorship for contract role. **Survives move: YES (if SG-based)** | 7 | Specific posting | |
| R201 | [Confidential FinTech SaaS via Bramwith Consulting] | Senior AI Engineer | Dubai, UAE (onsite) | Active Sep 2026 | Global trading/fintech SaaS firm; drives AI strategy execution — builds LLM/NLP-driven features + agentic user journeys + multi-step RAG for enterprise trading platform; defines roadmap for legacy → chat-based + agentic UX transformation; Python + LLM APIs + RAG + tool use + agentic orchestration; reports to CTO; **new company on shortlist**; AED 25k/month (~AUD 125k/yr, tax-free). ⚠️ Actual employer undisclosed — verify company identity + UAE employment visa sponsorship in first contact. **Survives move: YES (if Dubai-based)** | 7 | Specific posting | |

### Daily scout sources — 2026-09-15 (rows 339–342, R199–R201)
- [Atlassian — Senior ML Engineer AI Context (Rovo AI), Sydney/Melbourne/Brisbane (Workopia)](https://workopia.io/jobs/3615cd67c701effffa9bbc6a51a694c4)
- [Atlassian — Senior Machine Learning Engineer (freehire)](https://freehire.me/jobs/senior-machine-learning-engineer-atlassian-ptgqrd3x)
- [Atlassian — AI and Machine Learning Careers](https://www.atlassian.com/company/careers/engineering/ai)
- [CommBank — Staff Software Engineer AI/ML Payments Technology AI CoE (Dreamwork)](https://www.dreamworkhq.com/job/94b2f982-2c78-4493-8861-5c43a85e1f79)
- [CommBank — Staff Software Engineer AI/ML AI CoE Payments Technology (Workopia)](https://workopia.io/jobs/09a05cad8481c24c15b53588f438ff5f)
- [Emmbr — AI Engineer Agentic Engineering (Agentic Engineering Jobs)](https://agentic-engineering-jobs.com/)
- [Emmbr — 56 open jobs including AI Engineer Agentic Engineering (freehire)](https://freehire.me/companies/emmbr)
- [Blackroc — Senior AI / Machine Learning Engineer, Brisbane (blackroc.co)](https://blackroc.co/jobs)
- [Magellan Global — Senior AI Engineer AI Agents RAG Fine-Tuning, Singapore (MyCareersFuture)](https://www.mycareersfuture.gov.sg/job/engineering/senior-ai-engineer-ai-agents-rag-fine-tuning-magellan-global-d8522cb85553756605947959c5bbe464)
- [Magellan Global — Senior AI Engineer, Singapore (JobLeads)](https://www.jobleads.com/sg/job/senior-ai-engineer-ai-agents-rag-fine-tuning--singapore--ecb63914121aeed8e3772a6f101d81c1d)
...
### Daily scout — 2026-09-18

| Rank | Company | Role | Location | Posted | Why it fits | Fit | Type | Pursue? |
|------|---------|------|----------|--------|-------------|-----|------|---------|
| 347 | Aurecon | AI Engineer | Melbourne (Camberwell, hybrid) | Active Sep 2026 | One of AU's largest engineering/infrastructure consultancies (13k+ staff globally); embeds GenAI, chatbots, copilots + intelligent workflow automation into enterprise HR + engineering operations; high autonomy in a well-resourced org; confirmed AUD $140k–$160k + bonus; **new company on shortlist** | 7 | Specific posting | |
| 348 | Neara | Senior ML Engineer (Platform) | Sydney (remote-flex possible) | Active Sep 2026 | **DISTINCT from row 104 (digital-twin domain ML)** — this role owns the ML Platform: training pipelines, CI/CD, GPU compute, model serving + monitoring for physics-enabled electricity-grid simulation models; PyTorch + Kubernetes/Docker + cloud (AWS/GCP/Azure) + MLflow; **$160k–$220k confirmed** (Dreamwork listing); Series C, Times 100 Most Influential Companies 2024. ⚠️ Sydney-primary; no visa sponsorship | 8 | Specific posting | |
| 349 | BizData AU | Data Engineer | Remote (Melbourne CBD office available) | Sep 1, 2026 | AU data/analytics consultancy (25+ yrs, 200+ enterprise clients); remote-first role building scalable cloud data pipelines at AU SaaS company investing in AI; Azure + Python stack; graduate-to-senior range; **new company on shortlist**; est. AUD $120k–$145k. ⚠️ Confirm exact salary ≥ AUD 95k before applying | 7 | Specific posting | |
| 350 | Morgan Consulting (client undisclosed) | Lead Data Engineer | Melbourne (hybrid) | Active Sep 2026 | Via Morgan Consulting; established Melbourne enterprise; Databricks Lakehouse on Azure with direct exposure to productionised Agentic AI + Gen AI pipelines — highest-comp DE role in current shortlist; **AUD $180k–$190k confirmed**; Lead-level scope; **new recruiter on shortlist**. ⚠️ Recruiter — confirm end client identity + permanency pathway before applying | 8 | Recruiter posting | |
| 351 | Aurec Group (client undisclosed) | Senior AI Engineer (12-month FTC) | Melbourne CBD (5d onsite → hybrid) | Active Sep 2026 | Via Aurec Group; large enterprise org building internal AI capability from scratch; designs + builds chatbots, copilots, AI agents + intelligent workflow automations; researches emerging AI + provides governance advice; AUD $140k + super confirmed; hands-on greenfield AI mandate; **new recruiter on shortlist**. ⚠️ Fixed-term (12 mo); 5d CBD onsite for first 3 months — confirm hybrid flexibility before applying | 7 | Recruiter posting | |
| 352 | Professional Search Group (client undisclosed) | AI Engineer (6-month contract) | Melbourne (hybrid) | Active Sep 2026 | Via Professional Search Group; production-grade GenAI agents + autonomous agent architecture + enterprise system integration + evaluation/monitoring framework design; AUD $1,000/day confirmed (~$260k annualised); **new recruiter on shortlist**; distinct from PRA row 322 (different recruiter + end client). ⚠️ Contract (6 mo); confirm end client identity + renewal probability before applying | 8 | Recruiter posting | |
| 353 | Seeing Machines | Machine Learning Engineer | Remote AU (Canberra HQ) | Sep 8, 2026 | ASX-listed global computer vision company; driver + cabin monitoring systems deployed in millions of vehicles; curating datasets, training + validating ML models, building real-time ML algorithms, MLOps (Docker/MLflow/Metaflow); fully remote-AU; **new company on shortlist**. ⚠️ Salary not disclosed — confirm ≥ AUD 95k before applying. Computer vision domain (not LLM/agentic) | 6 | Specific posting | |

### Daily scout sources — 2026-09-18 (rows 347–353)
- [Aurecon — AI Engineer, Melbourne Camberwell (LinkedIn)](https://au.linkedin.com/jobs/view/ai-engineer-at-aurecon-4366977868)
- [Aurecon — AI Engineer Melbourne (SEEK)](https://au.seek.com/Aurecon-jobs/in-All-Melbourne-VIC)
- [Neara — Senior ML Engineer Platform, Sydney (Dreamwork)](https://www.dreamworkhq.com/job/2dd444dd-cafd-462e-a77d-3b697c1c1a01)
- [Neara — Senior ML Engineer Australia (ZipRecruiter AU)](https://www.ziprecruiter.com.au/jobs/591131310-senior-machine-learning-engineer-australia-at-neara)
- [BizData AU — Data Engineer Remote, Melbourne (freehire.me)](https://freehire.me/jobs/data-engineer-remote-bizdata-au-zuq3fh2g)
- [Morgan Consulting — Lead Data Engineer $180k productionised AI, Melbourne (freehire.me)](https://freehire.me/jobs/lead-data-engineer-melbourne-180-000-gain-productionised-ai-morgan-consulting-546bhqim)
- [Aurec Group — Senior AI Engineer FTC, Melbourne (freehire.me)](https://freehire.me/jobs/senior-ai-engineer-aurec-group-hc5b2kgg)
- [Professional Search Group — AI Engineer Contract, Melbourne (freehire.me)](https://freehire.me/jobs/ai-engineer-professional-search-group-jdtk6xm4)
- [Seeing Machines — ML Engineer Remote AU (australiajobs.app)](https://www.australiajobs.app/job/seeing-machines-machine-learning-engineer-remote-canberra)
- [Seeing Machines — ML Engineer (freehire.me)](https://freehire.me/jobs/machine-learning-engineer-seeing-machines-gmrdoyjb)
