...
- **Delivery/impact:** Enabled the client to identify ~**30% savings in one of their largest categories over a year** by surfacing price movement and cost leakage down to the product/venue/supplier level for better-negotiated supplier deals.
